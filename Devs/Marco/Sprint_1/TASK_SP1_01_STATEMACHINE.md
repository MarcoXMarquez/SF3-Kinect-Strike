# 📌 Tarea #1 [SP1-MARCO-01]: Máquina de Estados Core (FighterStateMachine.cs y FighterPhysics.cs)
...
Implementar la máquina de estados desacoplada en C# y la física de salto parabólico/locomoción sin depender de transiciones con flechas en Mecanim.
...
> *"Hola Antigravity, actúa como mi tutor de programación senior en Unity C#. Por favor lee este archivo y explícame paso a paso cómo estructurar y programar yo mismo los scripts FighterStateMachine.cs y FighterPhysics.cs con física parabólica y control de teclado."*
...
# 1. Guardar cambios
git add .
git commit -m "feat: máquina de estados core (fighterstatemachine.cs y fighterphysics.cs) (#1)"
